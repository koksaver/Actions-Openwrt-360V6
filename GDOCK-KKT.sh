...
# '修改默认主机名'
sed -i 's/ImmortalWrt/GDOCK-KKT/g' package/base-files/files/bin/config_generate
...
#修改默认无线名称
sed -i 's/ImmortalWrt/KKT/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
